...
module mousetrap_pipeline_top #(
    ...
    // ==========================================
    // DICHIARAZIONI ANTICIPATE (Forward Declarations)
    // ==========================================
    wire       done_1;
    wire       done_2;
    wire       done_3;
    ...
    // ==========================================
    // STADIO 1: Cattura Ingressi ed Elaborazione
    // ==========================================
    mousetrap_stage #(.WIDTH(8)) stage1 (
        .D({A, B, C, D}),
        .req(req_in),
        .ack(done_2),         // Ora done_2 e' gia' noto al compilatore
        .Q(latched_inputs),
        .done(done_1),
        .en()                 
    );
    ...
    // ==========================================
    // STADIO 2: Convergenza e Somma Finale
    // ==========================================
    mousetrap_stage #(.WIDTH(6)) stage2 (
        .D({sum_1A, sum_1B}),
        .req(req_to_stage2),
        .ack(done_3),         // Ora done_3 e' gia' noto
    ...
    // ==========================================
    // STADIO 3: Latch di Uscita (Protezione finale)
    // ==========================================
