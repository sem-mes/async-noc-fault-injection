...
- Memorizzazione: Al momento del release, entrambi i modelli intrappolano il guasto, mantenendo l'uscita stabilmente sul valore forzato.
- Dinamica: L'anello di retroazione delle porte logiche NAND incrociate reagisce al cambio di tensione forzato, ribalta il proprio stato interno e stabilizza fisicamente l'errore come se fosse stato campionato.
...
- Modello Comportamentale: Il Latch rimane incorrettamente incantato sul valore errato. Il costrutto always @(*) è event-driven: si riattiva solo in presenza di variazioni effettive sui fili di ingresso. Il comando release nel testbench non costituisce un evento. Senza una nuova variazione di D o EN, il blocco non viene rieseguito e l'uscita non si aggiorna, sovrastimando di fatto la letalità del guasto.
